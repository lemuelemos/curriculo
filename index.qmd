...
dados_cv %>%
  ...
  gt::gt() %>%
  gt::tab_header(
    title = gtExtras::img_header(
      img_url = "https://investidor10.com.br/storage/investment_advice/2BoSLNVozMWVwaQjH1gbZvC4fdnFCzI0KdmvaTMa.jpg",
                                 label = gt::md("RD Investimentos"))
  ) %>% 
