...
::: columns
::: {.column id="sidebar" width="30%"}
<center><a href='https://beamilz.com' target='_blank'> ![](https://avatars.githubusercontent.com/u/17839354?v=4){width="80%" style="border-radius: 50%;
padding-top: 5px;"}</center>
...
<a href='https://github.com/beatrizmilz' target='_blank'><i class="fa-brands fa-github"></i></a> 
<a href='mailto:milz.bea@gmail.com'><i class="fa fa-envelope"></i></a> 
<a href='https://twitter.com/BeaMilz' target='_blank'><i class="fa-brands fa-twitter"></i></a> 
<a href='https://discourse.curso-r.com/u/beatrizmilz/summary' target='_blank'><i class="fab fa-discourse"></i></a></center>
...
<p class="small">
Currículo feito com o  [Quarto](https://quarto.org/). Última Atualização em `r format.Date(Sys.Date(), "%b %d, %Y")`. 
<br> 
Código Disponível em <i class="fa-brands fa-github"></i> 
[GitHub](https://github.com/lemuelemos/cv/blob/main/index.qmd). 
<br>
